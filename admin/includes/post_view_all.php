        ...
        switch ($bulk_options) {
            ...
            case 'clone':
                ...
                if ($row) {
                    ...
                    mysqli_stmt_bind_param($query_clone_result, "isssssss", $post_category_id, $post_title, $post_author, $post_content, $post_tags, $post_status, $post_image, $post_users);
    ...
    <table class="table table-bordered hovered table-hover table-striped">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($query_post_result)) {
                ...
                if ($query_cat_result && mysqli_num_rows($query_cat_result) > 0) {
