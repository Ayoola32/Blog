...
function readAllCategories(){
    ...
    while ($row = mysqli_fetch_assoc($add_cat_result)) {
        ...
        echo "<td><a class='btn btn-info' href='categories.php?edit={$admin_cat_id}'>Edit</a></td>";
        echo "<td><a class='btn btn-danger' onClick=\"javascript: return confirm('Are you sure you want to delete Category')\" href='categories.php?delete={$admin_cat_id}'>Delete</a></td>";
